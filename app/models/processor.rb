	...
	def self.start()
		...
		pedidos.each do |pedido|
			...
			if temperatura_actual > temperatura_max
	            ...
	            ########################
	            Event.create(type: "quiebre (temp)", qty: temperatura_actual, unit: "Celsius", rut: pedido[:rut], orderId: pedido[:id], sku: pedido[:sku])
		...
		#agregue esto para procesar los pedidos ya recibidos pero q se interrumpieron por alguna razon...
		pedidos2 = Order.where("state = ?", "recibido")
		pedidos2.each do |pedido|
